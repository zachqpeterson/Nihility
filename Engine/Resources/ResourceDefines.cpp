...
SamplerInfo& SamplerInfo::SetAddressModeU(SamplerAddressMode u)
{
	addressModeU = u;
...
SamplerInfo& SamplerInfo::SetAddressModeUV(SamplerAddressMode u, SamplerAddressMode v)
{
	addressModeU = u;
	addressModeV = v;
...
SamplerInfo& SamplerInfo::SetAddressModeUVW(SamplerAddressMode u, SamplerAddressMode v, SamplerAddressMode w)
{
	addressModeU = u;
	addressModeV = v;
	addressModeW = w;
...
RenderpassInfo& RenderpassInfo::Reset()
{
	...
	colorLoadOp = ATTACHMENT_LOAD_OP_DONT_CARE;
	depthLoadOp = ATTACHMENT_LOAD_OP_DONT_CARE;
