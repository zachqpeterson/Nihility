...
struct String
{
    ...
    NH_API String Format(const String& format, ...);
    NH_API String FormatV(const String& format, void* vaList);
    NH_API void Empty();
    NH_API String Copy();
    ...
    NH_API void Append(char* dest, const char* source, const char* append);
