...
#define INFINITY ((F32)(HUGE_NUM * HUGE_NUM))
#define NaN (-(F32)(INFINITY * 0.0F))
...
public:
    ...
    static NH_API NH_INLINE U32 Length(I32 i) { return ((bool)i * (U32)Log10((F32)Abs(i)) + 1); }
    static NH_API NH_INLINE U32 Length(U32 i) { return ((bool)i * (U32)Log10((F32)Abs(i)) + 1); }
    static NH_API NH_INLINE U32 Length(I64 i) { return ((bool)i * (U32)Log10((F32)Abs(i)) + 1); }
    static NH_API NH_INLINE U32 Length(U64 i) { return ((bool)i * (U32)Log10((F32)Abs(i)) + 1); }
    static NH_API NH_INLINE U32 Length(F32 f) { return ((bool)f * (U32)Log10(Abs(f)) + 1); }
    static NH_API NH_INLINE U32 Length(F64 f) { return ((bool)f * (U32)Log10(Abs(f)) + 1); }

    //HASHING
    static NH_API NH_INLINE U64 Hash(const struct String& str, U64 max);
    static NH_API NH_INLINE U64 Hash(U64 value, U64 max);
private:
    Math() = delete;
};
...
struct NH_API Vector3Int
{
    ...
    Vector3Int(Vector3Int&& v) : x{ v.x }, y{ v.y }, z{ v.z } {}
    Vector3Int(const struct String& str);

    Vector3Int& operator=  (const Vector3Int& v) { x = v.x; y = v.y; z = v.z;	return *this; }
    Vector3Int& operator=  (Vector3Int&& v) { x = v.x; y = v.y; z = v.z;         return *this; }
...
struct Vector4Int
{
    ...
    Vector4Int(Vector4Int&& v) : x{ v.x }, y{ v.y }, z{ v.z }, w{ v.w } {}
    Vector4Int(const struct String& str);

    Vector4Int& operator=  (const Vector4Int& v) { x = v.x; y = v.y; z = v.z; w = v.w;	return *this; }
    Vector4Int& operator=  (Vector4Int&& v) { x = v.x; y = v.y; z = v.z; w = v.w;        return *this; }
...
struct NH_API Matrix2
{
    ...
    Matrix2(Matrix2&& m) : a{ m.a }, b{ m.b } {}

    Matrix2& operator= (const Matrix2& m) { a = m.a; b = m.b; return *this; }
    Matrix2& operator= (Matrix2&& m) { a = m.a; b = m.b; return *this; }
...
struct NH_API Matrix3
{
    ...
    Matrix3(Matrix3&& m) : a{ m.a }, b{ m.b }, c{ m.c } {}
    ...
    Matrix3& operator= (Matrix3&& m) { a = m.a; b = m.b; c = m.c; return *this; }
...
struct NH_API Matrix4
{
    ...
    Matrix4(Matrix4&& m) : a{ m.a }, b{ m.b }, c{ m.c }, d{ m.d } {}
    ...
    Matrix4& operator= (Matrix4&& m) { a = m.a; b = m.b; c = m.c; d = m.d; return *this; }
...
struct NH_API Quaternion
{
    ...
    Quaternion& operator=(Quaternion&& q) { x = q.x; y = q.y; z = q.z; w = q.w; return *this; }
    ...
    NH_INLINE Matrix3 RotationMatrix(Vector2 center) const;
