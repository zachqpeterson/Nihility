...
{
	//TODO: Max draw count
	vkCmdDrawIndexedIndirectCount(vkCommandBuffer, drawBuffer.vkBuffer, drawOffset, countBuffer.vkBuffer, countOffset, drawBuffer.size / sizeof(VkDrawIndexedIndirectCommand), sizeof(VkDrawIndexedIndirectCommand));
}
